...
@section('content')
    <div class="relative z-1 bg-white p-6 sm:p-0 dark:bg-gray-900">
        <div class="relative flex h-screen w-full flex-col justify-center sm:p-0 lg:flex-row dark:bg-gray-900">
                        ...
                        <div>
                            ...
                            <div class="relative py-3 sm:py-5">
                                ...
                                <div class="relative flex justify-center text-sm">
                                    <span class="bg-white p-2 text-gray-400 sm:px-5 sm:py-2 dark:bg-gray-900">**</span>
                                </div>
                            </div>
                            @if ($errors->any())
                                ...
                                <div class="space-y-5">
                                    ...
                                    <div>
                                        ...
                                        <input type="email" id="email" name="email" placeholder="info@gmail.com"
                                            {{-- value="{{ old('email') }}"  --}} value="admin@persi.com"
                                    ...
                                    <div>
                                        <button type="submit"
                                            class="bg-[#E77A2E] shadow-theme-xs hover:bg-brand-600 flex w-full items-center justify-center rounded-lg px-4 py-3 text-sm font-medium text-white transition">
                                            Sign In
                                        </button>
                                    </div>
                                </div>
            ...
            <div class="bg-[#0F3F3B] relative hidden h-full w-full items-center lg:grid lg:w-1/2 dark:bg-white/5">
                <div class="z-1 flex items-center justify-center">
                    <!-- ===== Common Grid Shape Start ===== -->
                    <x-common.common-grid-shape />
                    <div class="flex max-w-xs flex-col items-center">
                        <a href="/" class="mb-4 block">
                            <img src="./images/logo/logo-fav.png" alt="Logo" />
                        </a>
                        <p class="text-center text-gray-400 dark:text-white/60">
                            Aplikasi Cashlflow Persi Jawa Tengah
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div class="fixed right-6 bottom-6 z-50">
                <button
                    class="bg-[#E77A2E] hover:bg-brand-600 inline-flex size-14 items-center justify-center rounded-full text-white transition-colors"
