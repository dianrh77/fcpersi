            ...
            <div class="rounded-2xl overflow-hidden shadow-[0_10px_30px_rgba(0,0,0,0.12)] bg-[#F6E88E]">
                ...
                <div class="relative">
                    <div class="flex items-end mx-0 px-0">
                        <a href="{{ route('persi.kegiatan.pengajuan') }}" class="tab-umk tab-umk--left tab-umk--green"
                            :class="activeTab === 'pengajuan' ? 'tab-umk--active' : 'tab-umk--inactive'">
                            <span class="tab-umk__text">PENGAJUAN</span>
                        </a>

                        <a href="{{ route('persi.kegiatan.realisasi') }}" class="tab-umk tab-umk--mid tab-umk--orange"
                            :class="activeTab === 'realisasi' ? 'tab-umk--active' : 'tab-umk--inactive'">
                            <span class="tab-umk__text">REALISASI</span>
                        </a>

                        <a href="{{ route('persi.kegiatan.rekap') }}" class="tab-umk tab-umk--right tab-umk--yellow"
                        ...
                        <table class="min-w-full text-sm">
                            <thead class="bg-green-600 text-white">
                                <tr>
                                    ...
                                    <th class="px-4 py-3">No. Kegiatan</th>
                            ...
                            <tbody class="divide-y divide-black/10">
                                @forelse($kegiatans as $i => $k)
                                    ...
                                    <tr class="hover:bg-black/5">
                                        ...
                                        <td class="px-4 py-3 whitespace-nowrap font-bold">{{ $k->activity_no }}</td>
                                        <td class="px-4 py-3">{{ $k->activity_name }}</td>
